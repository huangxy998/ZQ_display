...
#define	LCD_CS_SET  GPIOC->BSRR=0x0040    //片选端口  		PC6
#define	LCD_RS_SET	GPIOC->BSRR=0x0080    //数据/命令 		PC7	   
#define	LCD_WR_SET	GPIOC->BSRR=0x0100    //写数据			PC8
#define	LCD_RD_SET	GPIOC->BSRR=0x0200    //读数据			PC9
								    
#define	LCD_CS_CLR  GPIOC->BRR=0x0040     //片选端口  		PC6
#define	LCD_RS_CLR	GPIOC->BRR=0x0080     //数据/命令		PC7	   
#define	LCD_WR_CLR	GPIOC->BRR=0x0100     //写数据			PC8
#define	LCD_RD_CLR	GPIOC->BRR=0x0200     //读数据			PC9
...
#define GRAY  			 0X4228 //灰色 1000010000110000
                                      //0100001000101000
#define SEABLUE          0X14DA
#define DARKGREEN        0X4B05
//GUI颜色
