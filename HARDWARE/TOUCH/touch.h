...
#define DOUT PCin(10)   //PC10  MISO
#define TDIN PCout(11)  //PC11  MOSI
#define TCLK PDout(2)  	//PD2 SCLK
#define TCS  PCout(12) 	//PC12 CS 
...
extern u8 touch_up_check(void);
extern u8 touch_pressed_down(void);
